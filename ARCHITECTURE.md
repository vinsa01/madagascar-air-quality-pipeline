...
| **Hébergement Airflow** | VM continue (machine du groupe) | Airflow n'est pas serverless : il faut un scheduler qui tourne 24h/24. C'est la contrepartie du choix "Airflow" vs une alternative serverless comme GitHub Actions. |
